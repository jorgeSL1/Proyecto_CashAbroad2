...
export default function Testimonial() {
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-blue-50/30">
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
          ...
          >
            <div className="space-y-6 sm:space-y-8">
              <div>
                <div className="font-display font-semibold uppercase text-4xl sm:text-5xl md:text-6xl text-blue-600 mb-2">200%</div>
              ...
              <div>
                <div className="font-display font-semibold uppercase text-4xl sm:text-5xl md:text-6xl text-blue-600 mb-2">70%</div>
          ...
          >
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex-shrink-0"></div>
              <div>
