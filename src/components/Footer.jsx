            ...
            <div key={category}>
              ...
              <ul className="space-y-2 sm:space-y-3">
                {links.map((link) => (
                  <li key={link}>
                    <a
                      href={link === 'Política de Privacidad' ? 'https://www.cashabroad.one/ppm' : '#'}
                      target={link === 'Política de Privacidad' ? '_blank' : undefined}
                      rel={link === 'Política de Privacidad' ? 'noopener noreferrer' : undefined}
                      className="font-body font-light text-xs sm:text-sm hover:text-white transition block"
                    >
                      {link}
                    </a>
                  </li>
